...
area = st.sidebar.number_input("Área total (m²)", value=dataset["area"].mean())
num_quartos = st.sidebar.number_input("Número de Quartos", value= int(dataset["num_banheiros"].mean()))
num_banheiros = st.sidebar.number_input("Número de Banheiros", value= int(dataset["num_banheiros"].mean()))
vagas_garagem = st.sidebar.number_input("Vagas de Garagem", value= int(dataset["garagem"].mean()))
num_andares = st.sidebar.number_input("Número de Andares", value= int(dataset["num_andares"].mean()))
